...
\renewcommand\subsection[1]{
	...
	%\begin{minipage}{\linewidth}
		\OldSubsection{% 	
			...
			\colorbox{drp!20}{\hspace{2.1em}}}%
			\hspace{-5pt}{\protect\transparent{0.6}{\colorbox{logoCyan!80!black}{\protect\transparent{1}{%
...
\newcommand{\lead}[1]{%
\noindent{\raisebox{1pt}{\relscale{1.25}{{{%
...
\renewcommand{\labelitemi}{{\color{red!60!black}$\star$}}
