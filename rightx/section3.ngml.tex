...
\begin{sentenceList}\sentenceItem{} Remember that wine we tasted on the Niagara 
...
\p{Despite thse variations, it seems rasonable to say that 
...
\p{We are now in position to dvelop a theory that 
...
othr than bald assertion to complicate the pragmatics, 
still the actual words depend on addresses drawing from 
...
could be reversed: I could i troduce \q{that win} 
...
(referring withing chains of dialog, e.g. 
...
\q{dscrriptive additions} \mdash{} can themselves be distinguished 
...
designation) and potentially can compel subsequent 
conversation to focus on that time and/or place.  
Finally, I will identify a class of frame-modifications 
which are the \i{details} ...
}
\p{I will also assume that the machinery of frames is ognitive, 
not just linguistic.  We have analogous faculties for 
\q{refocusing } attentions and adding conceptual details 
via intraction with our nvironmnt, both alon and with othrs, 
and both via language and other means.  Some 
aspects of \i{linguistic} cognitive framing \mdash{} like 
the \q{ledger} of referents prviously established in a 
conversation \mdash{} may be of a purely linguistic character, 
but these are the exception rather than the rule.  
In the typical case we haveva latent ability to 
direct attention and form beliefs by 
direct observation or by accepting others' reports as 
proxies for direct obsevration.
}
\p{When we are told that two dogs are male, for instance, 
we may not perceptually encounter the dogs but we undertand what 
sorts of preceptual disclosures could 
serve as motivation for someone believing that idea.  We therefore 
assume that such belief was initially warraned by 
obsevration and subsequently got passed through a chain 
of language-acts whose warrants are based in the perceived 
credibility of the speakr.  But internal to this 
...
Here I still don't really have a picture of what it is 
...
is a Staffordshire (compared to those announcing its 
gender, say).  But insofar as I am acquaihted 
wuth the concept \i{dog breed}, I also understand 
the general pattern of these observations.  For instance 
I may know breeds like poodles or huskies and be able to 
idenitfy \i{these} by distinctive visual cues.  I alos 
...
how claims beliefs about breeds are formed based on 
...
based on the beliefs of othrs, but this is possible because 
...
substancs.  If I never learn what Stafforshire is, 
...
me anticipate his behavior).  Nevertheless even knowing 
...
understand \q{unspoken} norms by asking questions.  But 
many situational assumptions ar extralinguistic because 
they are (by convention) not explicitly stated, 
even if they accompany content that \i{is} explicitly stated.  
\q{This is Syrah} acccompanid by the gesture of handing 
me glass is an indirect invitation for me to drink it 
(compare to \q{Please hold this for a second?} or 
\q{Please hand this toe th man behind you}). 
}
\p{I bring to every linguistic situation a 
capcity to make extralinguistc observations, and 
...
extralinguistic reasoning is xpected to fill 
\mdash{} is direcly expressed, like in \q{See the 
dog over there?}.  But elsewhere the 
\q{extralinguistic implicature} is more indirect, 
as in \q{This is Syrah} and my expected beliefe that 
