...
might take.  If in () I am not issuing a directive, I 
...
the capacity for language to share beliefs 
...
\p{For sake of discussion, I will dub that part of the \q{active} 
cognitive frame, for some discussion, the \q{doxa inventory}.  
This \q{database}-like repository stands alongside the 
\q{ledger} and \q{lens} to tract propositional content 
asserted, collectively established, or already 
considered as background knowledge, \visavis{} sme 
discourse.  Manipulation of the lens and ledger allows 
spakers to designate propositional contents which they 
...
(along the lines of, that a traffic light 
...
via interaction with our environment, both alone and with othrs, 
...
credibility of the speaker.  But internal to this 
...
understand unspoken cues and assumptions.  Many situational 
