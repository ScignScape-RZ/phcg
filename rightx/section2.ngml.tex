...
disjunctive predicate.  But this does not mean 
...
speaker presumably dos not merly want 
...
what speakrs are supposed to say as social acts, which seems 
...
paradigm would sm to need the derivational dependsnce 
...
achieve its effect.  It needs some logical content, but it exploits a 
kind of disconnect between the play of logic and the play 
of practical action.  I think this xample has som structural 
analogs to the grandma window case: there we 
play at logical substitutions to respond practically 
to grandma's request in spirit rather than \i{de dicto}.  Here 
a secretary or bodyguard can engage in logical 
substitution to formulate a linguistic performance 
dsigned to, in effect, ask us to leave, but to do so 
while conveying a slittle information as possible.  The logical 
substitution in this context is a diminution in 
logical content.  We can strip away logical dtail from 
...
other than fully terminate: effect is partially autonomous from 
