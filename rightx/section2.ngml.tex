...
that any one segment of code is typically daling with 
...
explicit appeals formal logic machinery (substitution 
...
implies a counter-request that the visitor leave).  
...
rtraoctive reductionism), \i{not} a logical 
