...
\sentenceItem{} \label{itm:corkscrew} He pounded the nail with a lever corkscrew.
\end{sentenceList}
...
back to (\ref{itm:corkscrew}), proposing to use a winged corkscrew.  
So the implicature in (\ref{itm:corkscrew}) is satisfied, let's say, 
