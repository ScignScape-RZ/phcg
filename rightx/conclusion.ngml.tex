...
\p{When distinguishing \q{cognitivee} from \q{precognitive}, however, 
...
variations in ()-():
\begin{sentenceList}\sentenceItem{} Our house is across the lake.
...
prior knowldge we instinctively make on hand in 
...
incongruity in extending the concpt on 
...
\begin{sentenceList}\sentenceItem{} I'm going to a party at my brother's house (suppose 
...
usage in () is less proper in the contxt of 
...
\p{The efficacy of the concept lies not just in the reality 
...
\i{why} it is so suited is how it is shapd and 
...
bcome solicited within language, for instance 
...
that role in \i{prototype} situations, which 
is why it dos not cover hammers.  This is one rason why we should 
...
situations that embody situational prototyps.  This 
...
concptual roles offer templates that allow cognitive-perceptual 
judgments to be passive or instinctively \mdash{} we reach 
for a butter knife without being aware of concluding 
that said instrument is a butter knife, or even being 
awate of knowing that a butter knife is there.  
}
...
and moment-to-momnt enactive needs and processes, all 
...
working for other people, and threfore can 
...
object recognition and asociated concptualizations, 
are highly subtle and multfacted cognitive faculties 
\mdash{} especially in our purposeful, socially normative, 
often emotionaly charged human world.  Some aspects of 
this overall architecture may be interestingly modeled 
or emulated with computers.  Examples include 
Raubal's and Holmqvist's implementations basd on 
...
Jean Ptitot.  I am skeptical that 
