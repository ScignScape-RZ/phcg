...
seeking artifical, computtaionally engineered replicas of 
human cognition.  \i{Computational} does not have to equal 
\i{AI}.  
}
\p{Holmqvist's and Selway's research that I hav cited are good examples 
of paradihm-overlap between cognitiv and computational 
...
sense-perceptual minutiase.  Our mental map of our 
surroundings \mdash{} there's the corkscrew, there's 
the carving knife \mdash{} pulls these referents 
outside the register of thematized sensate consciousness and 
...
theory of thesesemi-abstract layersof cognitive processing 
are only half the story.  Suppose we agree that there 
is legitimate cognitive insights in Holmqvist's model cognitive 
...
more conceptual-role accpunt for analogous phenomena).  
...
operate in an environmentwhere these 
Intermediate Representations are valuable 
primarily because and insofar as they allow 
human cognition to be mechanically recoprocated.  
...
outpue; a structure between two other structures, 
where the role of the interface is to bridger 
the structures as well as to activate the correct 
capabilities with the output.  This is the 
...
IR-to-runtime engineering.  Unfortunately, 
I get the sense that a lot of AI research does 
not respect a comparably disciplines Separation Of 
Concerned, casuing particular parts of projects to be 
unfairly judged basd on whether they contribute 
to what are, I believe, unrealistic visions 
of humanoid robots and conversationalists.
}
...
part of one's scholarly modus operandican inckuding 
writingbcomputer code, and studying code 
repositories developed by others, we can benefit from a 
hands-on, even trial-and-error kind of experimentation.  
Software which can be given concrete tasks \mdash{} if it 
...
of intllectual engagement.  We get \i{that} to work, then 
...
seem to unfold in slow motion. 
}
\p{Perhaps for this rason, some of the most interesting 
cogniitive models hacve come from 
...
\p{I myself am most committed, however, to practical software that 
...
CSTX allows linguists to consider a type-thoretic 
reprsentation of linguistic data, or language-as-interface
\q{intermediate structures}, \i{without} presuming 
that automated (AI or machine-learnin) systems 
could necessarilr generate Intermeiate Representations 
without human intervention.  It is not 
s \q{practical} software systekbinbthe AI sense of 
...
perhaps serve sas a case-study in 
...
paradigms ar probably more likely to 
