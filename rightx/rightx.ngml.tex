...
\include{commands}
\begin{document}\title{The Right Kind of Externalism: A Proposal}
...
\p{Meanwhile, as a Phenomenologist I am a committed 
...
\q{in my brain} \mdash{} my brain is over here, not 
...
\p{I'm not ignoring that \q{external} in the sense 
...
\q{science} \mdash{} that is, a well-constructed 
...
`p`
\p{This bears riterating: when considering a science 
...
\mdash{} biology to chemistry to physical \mdash{} as a genr 
...
for analyzing sociological or nurophysical laws in turn \mdash{} 
...
programming \mdash{} the field sonetimes calld 
...
\p{The hierarchical natur of computer architecture 
...
case-studies of artifacts ghat are in some sense 
...
The internet?  Of course, many instances of 
\q{mind as computer} analogic reasoning are not explicit 
research paradigms bing proposed forth but are more 
...
but software evincing intllignt bhavior can be implemented 
...
language usrs maintain an internal store of 
...
be a transgender woman, and divorces can remarry each 
other.  We can debate whether these are semantic or 
pragmatic issus (I think they're the former, but let's 
say they ar the latter for sake of argument).  So 
...
computers are not ANNs (though thy may implement them).  
...
really mind picrured as a computer programmed 
...
thinking about is not \q{computrs} but some sort of 
...
get defended \i{by appeal to} mind-as-logico-functional-systemies.   
...
\p{So, my strategy for the rmaining sections of this 
paper is as follows: I will review some 
language-philosophy contoveries and argue 
...
mereologies (e.g., tissues are both phsyically 
...
and analyzing the transition between them.  It write 
...
Biology does not need to solve such ewuations, 
