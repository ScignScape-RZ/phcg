...
judgments and intentions that (in concrete form) are not \q{computable} (although 
I make no metaphysical claims about the \q{abstract} computability of mental 
processes merely by virtue of their neurophysical materiality).  However, 
our propensity to call up certain construals rather than others is triggered by 
...
physical science achieves via empiricist Ontology.  For all its limitations, Positivism 
...
(say) logic, but the phenomenological tradition is distinct in that 
...
almost primordial example of a \Gardenfors{} Conceptual Space).  This kind of transformation,  
described (say) via differential geometry, is \i{qua} theoretical device 
an example of semiotic morphism, a mapping between representation disciplines.  
...
color data from geometry as an approximation to a \i{process}, 
...
morphism has an analogue in the mapping of word-sequences to semantic graphs.  
...
phrase-aggregate hypernodes or frames, and the rest.  There are not, necessarily, for example, 
