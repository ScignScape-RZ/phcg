...
\AddToShipoutPicture{%
	\ifthenelse{\equal{\thepage}{\string v}}{%
	\AtPageLowerLeft{%
		\hspace*{1.5em}
		\rotatebox{90}{%
			\begin{minipage}{\paperheight}
			\centering
			{\color{copyc!35!gray}\textcopyright ~2019 Michael Lesher}
			\end{minipage} %
		}
	}} %
{}	
...
$l: bot:AmiraHass
$p: 6
$x. Amira Hass is an Israeli journalist who has reported for
years on the suffering of Palestinians in Gaza and elsewhere
in the Occupied Territories. She is the author of 
\textit{Drinking the Sea at Gaza}.
.
/!
<>>
/!
