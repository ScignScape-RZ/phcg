...
\definecolor{blineColor}{rgb}{.2,.7,.3}
%\colorlet{LightBlue}{BlueLUH!20!white}
\colorlet{lineColor}{blineColor!70!black}
...
\marginpar{\ifxmargrefstomargin\hspace*{.5\leftmargin}\fi\scriptsize {\hyperlink{#1}{\dag}}}}
...
%\makeatletter\Hy@raisedlink{\protect\hypertarget{#1}}\makeatother
\protect\raisebox{-6pt}{\protect\parbox{17cm}{{\color{lineColor}{\rule{11cm}{0.1pt}}}\\#2}}
}}
...
\geometry{textwidth=6in,textheight=7.6in}
...
\textit{Yisgadal v'yisqadash}...but\verseline
