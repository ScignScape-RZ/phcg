...
\begin{stanza}
ctg: one wreck of a car.\verseline
...
\begin{ccframed}
\begin{description}\item[QR Code]
QR Codes on each page can be used by readers switching 
between print and digital versions of this document.  The QR figures 
encode bibliographic and page information which can be used by 
conformant PDF software to show the interactive PDF version of each page.
\item[Embedded Data]
