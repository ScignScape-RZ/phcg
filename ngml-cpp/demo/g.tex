...
\makeatletter
\newcommand{\poemtitlear}[2]{%
	\set@p@emtitle{#2}{\poemtitlepenalty}{\poemtitlefont}%
...
{\poemnewpage}
\hypertarget{item:b}{}
\poemtitlear{Thinking of Gaza from Thousands of Miles Away(\hyperlink{item:b}{item b})}{THINKING OF GAZA FROM THOUSANDS OF MILES AWAY}
%poemtitlear{X}{THINKING OF GAZA FROM THOUSANDS OF MILES AWAY}
...
{\poemnewpage}
\poemtitlear{Burlesque at the Barrier}{BURLESQUE AT THE BARRIER}
\begin{poem}
...
{\poemnewpage}
\poemtitlear{Drinking It}{DRINKING IT}
...
{\poemnewpage}
\poemtitlear{Silent Movie}{SILENT MOVIE}
...
{\poemnewpage}
\poemtitlear{Jewish Journal and Bad Dreams}{JEWISH JOURNAL AND BAD DREAMS}
\begin{poem}
...
{\poemnewpage}
\poemtitlear{Three Words for the Dead}{THREE WORDS FOR THE DEAD}
\begin{poem}
...
{\poemnewpage}
\poemtitlear{Clowns with Swastikas}{CLOWNS WITH SWASTIKAS}
\begin{poem}
...
{\poemnewpage}
\poemtitlear{Dead God, Dying God}{DEAD GOD, DYING GOD}
\begin{poem}
...
{\poemnewpage}
\poemtitlear{An Untimely Man}{AN UNTIMELY MAN}
\begin{poem}
...
{\poemnewpage}
\poemtitlear{Cyrano de Marianne}{CYRANO DE MARIANNE}
...
{\poemnewpage}
\poemtitlear{The Storm Scene}{THE STORM SCENE}
...
{\poemnewpage}
\poemtitlear{Crime Scene}{CRIME SCENE}
\begin{poem}
...
{\poemnewpage}
\poemtitlear{The Survivor}{THE SURVIVOR}
\begin{poem}
...
{\poemnewpage}
\poemtitlear{The Walls}{THE WALLS}
\begin{poem}
...
{\poemnewpage}
\poemtitlear{My Devil Curses Me}{MY DEVIL CURSES ME}
\begin{poem}
...
{\poemnewpage}
\poemtitlear{Pines in the Suicides' Wood}{PINES IN THE SUICIDES' WOOD}
...
{\poemnewpage}
\poemtitlear{Death in Palestine}{DEATH IN PALESTINE}
\begin{poem}
...
{\poemnewpage}
\poemtitlear{Why It Mattered}{WHY IT MATTERED}
...
{\poemnewpage}
\poemtitlear{My Kaddish}{MY KADDISH}
...
{\poemnewpage}
\poemtitlear{Elegy for a Child}{ELEGY FOR A CHILD}
