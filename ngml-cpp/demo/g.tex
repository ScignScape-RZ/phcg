...
\renewcommand{\footnoterule}{%
  \kern 5pt
  {\color{blineColor!60!black}{\hrule width \textwidth height 2pt}}
  \kern 4pt
}
...
\newcommand{\xtextnote}[2]{\textnote{\hypertarget{#1}%
\protect\raisebox{-6pt}{\protect\parbox{\textwidth}{{\color{lineColor}{%
\setlength{\rulelen}{\textwidth}
...
\geometry{textwidth=6in,textheight=7.6in,headsep=32pt}
...
\newcommand{\basicpoemtitlear}[3]{%
	...
	\c@ntentsinfo{#2 \hspace{2em}\hyperlink{#1}{\rar}}{\contentsindentone}{\contentspoemtitlefont}%
...
\newcommand{\poemtitlear}[3]{\hypertarget{#1}{}\basicpoemtitlear{#1}{#2}{#3}}


\newcommand{\mypageref}[1]{\hfill\getpagerefnumber{#1}\hspace*{10em}}
...
%\newcommand{\xtheverselinenumber}{%
%\fcolorbox{orange!50!black}{white}{\fcolorbox{orange!50!gray}{white}{\theverselinenumber}}}	


%\newcommand{\xtheverselinenumber}{%
%\begin{mdframed}[style=MyFrame,nobreak=true,align=center]\raisebox{1em}{\theverselinenumber}\end{mdframed}}
...
{\poemnewpage}
%\hypertarget{item:b}{}
\poemtitlear{item:Thinking}{Thinking of Gaza from Thousands of Miles Away}{THINKING OF GAZA FROM THOUSANDS OF MILES AWAY}
%poemtitlear{item:}{X}{THINKING OF GAZA FROM THOUSANDS OF MILES AWAY}
...
{\poemnewpage}
\poemtitlear{item:Burlesque}{Burlesque at the Barrier}{BURLESQUE AT THE BARRIER}
\begin{poem}
...
{\poemnewpage}
\poemtitlear{item:Drinking}{Drinking It}{DRINKING IT}
...
{\poemnewpage}
\poemtitlear{item:Silent}{Silent Movie}{SILENT MOVIE}
\epigraph{Every where at the approach of the white man {\lbrack}the Indians{\rbrack} fade away.... We hear the rustling of their footsteps, like that of the withered leaves of autumn, and they are gone for ever.
\\\textnormal{--- Joseph Story, U.S. Supreme Court justice}}
\epigraph{We never really conquered Lydda.... {\lbrack}T{\rbrack}here was really no city to conquer. The whole place...was empty.
...
{\poemnewpage}
\poemtitlear{item:Jewish}{Jewish Journal and Bad Dreams}{JEWISH JOURNAL AND BAD DREAMS}
\begin{poem}
...
averted as they pass the word, row on silent row,\verseline
	It's nothing, never mind?\verseline
...
I try to say to the dead,\verseline
	I have tasted your unmoving air, and retched.\verseline
...
Today I watched a film made in the ruins of Shuja'ya\verseline
...
{\poemnewpage}
\poemtitlear{item:Kaddish}{Kaddish}{KADDISH}
\begin{poem}
...
\xtextnote{bot:Glorified}{From the Mourner's Kaddish: \q{Glorified and sanctified be God's name ...}}
...
{\poemnewpage}
\poemtitlear{item:Oranges}{Oranges}{ORANGES}
\begin{poem}
...
{\poemnewpage}
\poemtitlear{item:Lecture}{Lecture}{LECTURE}
\begin{poem}
...
{\poemnewpage}
\poemtitlear{item:Three}{Three Words for the Dead}{THREE WORDS FOR THE DEAD}
\begin{poem}
...
{\poemnewpage}
\poemtitlear{item:Clowns}{Clowns with Swastikas}{CLOWNS WITH SWASTIKAS}
\begin{poem}
...
the IDF parades in the \textit{New York Times}.
\end{stanza}
\end{poem}


{\poemnewpage}
\poemtitlear{item:Dead}{Dead God, Dying God}{DEAD GOD, DYING GOD}
\begin{poem}
...
{\poemnewpage}
\poemtitlear{item:AnUntimely}{An Untimely Man}{AN UNTIMELY MAN}
\begin{poem}
...
{\poemnewpage}
\poemtitlear{item:Cyrano}{Cyrano de Marianne}{CYRANO DE MARIANNE}
\epigraph{Welcome to Israel!  It seems you got lost. Perhaps you meant to sail to a place not far from here --- Syria. There the Assad regime slaughters his people every day with the support of the murderous Iranian regime.\\\textnormal{--- Israeli Prime Minister Benjamin Netanyahu, in a letter delivered to humanitarian activists when they were kidnapped by IDF sailors from their fishing boat, the Marianne, while attempting to break Israel's siege of Gaza and deliver medicine to the inhabitants (June 2015)}}
...
some of Goebbels' graceful prose.\verseline
But no,\verseline
...
{\poemnewpage}
\poemtitlear{item:Drone}{Drone}{DRONE}
\begin{poem}
...
{\poemnewpage}
\poemtitlear{item:TheStorm}{The Storm Scene}{THE STORM SCENE}
...
{\poemnewpage}
\poemtitlear{item:CrimeScene}{Crime Scene}{CRIME SCENE}
\begin{poem}
...
{\poemnewpage}
\poemtitlear{item:TheSurvivor}{The Survivor}{THE SURVIVOR}
\begin{poem}
...
{\poemnewpage}
\poemtitlear{item:TheWalls}{The Walls}{THE WALLS}
\begin{poem}
...
{\poemnewpage}
\poemtitlear{item:MyDevil}{My Devil Curses Me}{MY DEVIL CURSES ME}
\begin{poem}
...
{\poemnewpage}
\poemtitlear{item:Delirium}{Delirium}{DELIRIUM}
\begin{poem}
...
{\poemnewpage}
\poemtitlear{item:Farewell}{Farewell}{FAREWELL}
\begin{poem}
...
{\poemnewpage}
\poemtitlear{item:Fanatics}{Fanatics}{FANATICS}
\begin{poem}
...
{\poemnewpage}
\poemtitlear{item:Pines}{Pines in the Suicides' Wood}{PINES IN THE SUICIDES' WOOD}
\dedication{(see Inferno, Canto XIII)}
\epigraph{If there is no future, there is no hope.
...
{\poemnewpage}
\poemtitlear{item:DeathInPalestine}{Death in Palestine}{DEATH IN PALESTINE}
\begin{poem}
...
{\poemnewpage}
\poemtitlear{item:WhyItMattered}{Why It Mattered}{WHY IT MATTERED}
\epigraph{On Tuesday, August 19 [2014], the Israel Defense Forces...announced that Cpl. David Menachem Gordon...was found dead in central Israel, his weapon at his side.... We understood from the code phrase, \cq{weapon at his side,} that Gordon had committed suicide.\\\textnormal{--- Rabbi Yehoshua Looks}}
\epigraph{Unable to disclose his mortifying secret, the boy can only fantasize revenge on those vile men whose twisted lustful current raged through their veins.... He dreams of an escape from his Hell... As much as he tried, he could not ignore the scattered scars that sexual abuse left on his Soul.%
...
sons, when his brigade's guns were torching houses with\verseline
	\cq{repeated shelling} as the victims fled...\verseline
maybe he believed his colonel when that maniac\verseline
	pronounced Palestinians the enemies of God.\verseline
Or, maybe he was maddened with the mumbling myth\verseline
	of soldiers who believe themselves invincible,\verseline
...
his unit killed in a \cq{summary execution} in Khuza'a\verseline
	one August day, nor the hundred or more helpless who fell\verseline
...
who offered only terror against the ugly threat\verseline
	(a barrel shaft upright, burning to invade\verseline
	 a child, impale his innocence)...\verseline
...
though once the victim, you are among the strong.}\verseline
	(Some who were his friends now carried suspect memories\verseline
	and had to go.) Or, heard in a whisper, a taunt in his ear,\verseline
\cq{Have no pride. What men did to you, you've done.}\verseline
	(And would do again, for no slogan could shatter\verseline
...
{\poemnewpage}
\poemtitlear{item:MyKaddish}{My Kaddish}{MY KADDISH}

\epigraph{Magnified and sanctified may His great name be
...
And may he reign\verseline
	(if anything should reign)\verseline
...
I cannot cast it out, but I can rant,\verseline
 	(and ranting, raise a pure shout\verseline
	heavenward),\verseline
...
{\poemnewpage}
\poemtitlear{item:Elegy}{Elegy for a Child}{ELEGY FOR A CHILD}
