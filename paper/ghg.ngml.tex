...
\begin{flushright}
\begin{minipage}{22em}
On conna\^{\OldI}t la c\'{e}l\`{e}bre affirmation de Claude L\'{e}vi-Strauss: 
...
\begin{flushright}
\begin{minipage}{22em}
What does $M$ really do in the information system?  It acts as
...
\\ \longdash{} Orlin Vakarelov, \cite[p. 1]{OrlinVakarelov}{}
\end{minipage}
\end{flushright}
\vspace{1em}
\input{intro.ngml}
