...
First, akin to Natural Language, digital data often emanates from 
textual representations, with data structures initialized 
from special \q{languages} like \XML{} or \JSON{}.  Second, as with 
...
whose elements can be nested documents.  And, third, as with 
...
of data structures can be marshaled into different binary forms \mdash{} 
...
properly encode data structures for binary runtimes.  These varying 
...
\p{As a case in point, Semantic Web structures such as 
...
\raisebox{.25em}{{\footnotesize 
\dblhref{https://www.https://github.com/scignscape-rz/phcg}}}.) 
}
\vspace*{-1em}
