...
Labeling and Annotation Engine}).  RelaeGraph grammars are 
...
graphs to hypergraphs is then analogous (and, in practice, an 
...
\lstinline[columns=fullflexible]{flags\_all\_(parse\_context ,inside\_string\_literal), run\_context}.
...
attending to graph operations.  Simultaneously, the 
components which do modify hypergraphs can be developed 
...
in how information about input text is preserved in the output structure.  
