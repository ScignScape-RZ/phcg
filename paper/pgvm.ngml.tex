...
generic representational paradigm for data sharing and publication.  
...
and a \q{Procedural Hypergraph Ontology} (\q{Phaon}).    
...
which adopts hypergraphs as the principal internal data representation.  
This paper is paired with a code repository demonstrating such a 
Hypergraph Virtual Machine (\q{PhaonGraph Virtual Machine}).  
I outline parsing and compiler techniques for this Virtual Machine as 
a case-study in the supporting ecosystem necessary for 
