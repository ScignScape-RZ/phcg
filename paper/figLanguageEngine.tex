...
hex/.style = {draw=red!20!black, inner sep=-1, 
    ...
    \hexnode{below right = 10mm and -20mm of nSrcCode}{nPGBIR}{PGBIR} 
   ...
   \draw (nRelaeGraph.north)+(-7mm,0mm) edge [yshift=1mm, bend right = 8, <-]  
     node [yshift=3mm] {hypergraph parser} (nSrcCode);
   \draw (nPGBIR.north)+(7mm,0mm) edge [above, bend left = 8, <-] 
     node [yshift=-1mm,xshift=-2mm] {Phaon Graph Build} (nRelaeGraph.west) ;
   \draw (nPGBIR) edge  [bend left = 8, ->, shorten >=.5mm]  node {} (nPhaonGraph.north);
