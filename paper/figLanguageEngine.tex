...
\end{tikzpicture}
\tmphscol\caption{\emblink{\#fig--LanguageEngine--\thefigure.pgvm-pdf}{Compiler Pipeline for the PhaonGraph Virtual Machine ({\protect\PGVM})}} \label{fig:figLanguageEngine}
\end{figure}
