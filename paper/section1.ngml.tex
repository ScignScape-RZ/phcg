...
or tuple type intlernally containing its own body of information.  
...
format.  The theoretical correlary to this idea would be that node data 
...
structures, where information is routed ampong different environments 
...
because conctructing a working runtime engine which runs source 
