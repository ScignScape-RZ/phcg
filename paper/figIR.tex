\tmphs\begin{lstlisting}[language = lisp, numbers = none, 
caption={\emblink{\#lst--IR--\thelstlisting.pgvm-pdf}{Hypergraph Intermediate Representation}},label={lst:figIR},
...
(pgb::add_block_entry_node :|<!>last_block_pre_entry_node| 
   :|<->entry-node|)
...
(pgb::make_channel_fground_entry_node :|/--result| :|/--u4| 
   :|-->cfx-node|)
