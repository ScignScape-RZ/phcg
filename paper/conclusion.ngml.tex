...
\p{The Phaon-Graph compilers and \PGVM{} works on 
...
\PGVM{} system \mdash{} how the graph, parsing, and virtual-machine-runtime 
components are integrated together.  So far, this Ontology 
is not formally articulated \mdash{} we do not yet have a common 
picture of how to construct \OWL{}-like Ontologies for 
hypergraphs with this spectrum of extra structure.
}
\p{\lPGVM{} is one example that points to larger questions: 
...
is partly notational \mdash{} what would be a convenient language 
...
\mdash{} obtaining data from (say) open-access publishers' or 
...
conventional data-visualizations, etc.).\footnote{Developing precise scientific metadata standards is 
...
\mdash{} including serious critiques of the Semantic Web.  
...
of procedures, algorithms, computational strategies \mdash{} in general, 
...
the \PGVM{} \mdash{} would then be characteristic 
