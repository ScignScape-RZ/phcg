...
\include{commands}
\begin{document}\title{Phenomenological Formalization: The Case of 
  Cognitive Grammar}
\p{Cognitive Grammar in relation to Linguistics 
...
situational structures \mdash{} as such, language 
...
but evidence-based methodology \mdash{} linguists using their 
...
preferences the linguist herself may have \mdash{} is common 
...
of, say, acceptability \mdash{} rather than comparingb a given 
linguistic performance against dictionaries or style-books 
\mdash{} Cognitive Grammar eveals a metatheoretic commitmnt to the 
...
\p{Cognitive Grammar, in short, requires for the coherence of its 
scientific aspirations that a kind of first-personal but 
social-pragmatic analysis \mdash{} which we can argue is quite akin to 
Phenomenology \mdash{} can be performed which is also 
...
\p{From at least a metascientific perspective, at least, a 
...
\p{Notice however that Cognitive Grammar does intrinsically orient 
analysis to disciplinary commitments \mdash{} to the accuracy of 
...
among a language community \mdash{} which cannot be just passively 
...
vs. disclosure \mdash{} the commitments that can be 
...
\mdash{} or, conversely, belief that the rich experiential structure 
...
explanatory revelations about human language \mdash{} contemporary 
...
buttressed by computational evidence \mdash{} whether 
...
\p{Cognitive Linguistics in general does not need to 
mimic these practical concerns \mdash{} after all, if language 
...
how a plethora of environing situations \mdash{} the 
spatial and force-dynamic arrangements trenchant to our construal 
of practical scenarios \mdash{} can be sorted into a 
...
coordinated thought and normative signification \mdash{} as 
...
can be studied in abstraction \mdash{} first because 
...
\p{Phenomenology, also, gathers consciousnss as reflected upon into 
...
to say, or to later recall, that \q{I walked into the room} \mdash{} the 
...
\mdash{} minimally the temporality of, but more consequentially, 
...
\p{Meanwhile, an equally salient structuring principle lies in 
...
I don't need to confirm \mdash{} if I briefly glance and see him 
lying still and relaxed \mdash{} that the tabby cat on the couch is 
...
\p{Here, too, is an apparently \q{transcendental} or \q{categorical} 
(allowing a Kantian echo) pattern in consciousness \mdash{} the sliding 
...
violated \mdash{} say I suddenly see Hugo, having awaken, jump 
...
set against \mdash{} and in consciousness interweaves with 
\mdash{} the scales of temporality.
}
\p{We have then at least this matrix \mdash{} the double-scale of temporal 
granularity and epistemic attentiveness \mdash{} which seems 
...
intersubjectively negotiated perception \mdash{} we may not see the same 
...
\p{Cognitive Grammar also has ur-structures \mdash{} for sake of 
...
\mdash{} no code-repositories curated by Phenomenology 
...
\p{Language, in short, is \mdash{} at least on one level \mdash{} a 
...
force-dynamic schema are \mdash{} for example and so to speak \mdash{} 
...
described via \q{parse graphs} \mdash{} the parsed sentence notated, 
...
\mdash{} then morphosyntactic agreement is a paramter manifest 
in specific inter-word pairs.  So morphosyntactic agreement 
qua linguistic phenomenon straddles the experiential 
and formal realms \mdash{} it can be studied in terms of 
...
\p{I would like to juxtapose this interdisciplinary continuation 
of Cognitive Grammar with the academic dissemination of 
Phenomenology \mdash{} how the professional philosophical milieu where 
...
of Cognitive Grammar \mdash{} the discipline of 
acdemic writing, peer review, conferences \mdash{} there are 
...
\p{The paradigms of these research programs that emphasize 
...
mental phenomena seems to diverge in two irections \mdash{} one being 
...
\mdash{} which in turn can be modeled as formal systems 
...
\p{The preceding discussion has set forth why I believe the 
