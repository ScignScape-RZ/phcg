...
metaphorical and figurative ffect, broadening the semantic scope 
...
varying some of the prototypical frame details:  mayb th 
...
the underlying lxical level \mdash{} we can assess these by reference 
...
mass-plural \q{coffee} (as in \q{som coffee}) figures the 
...
\end{sentenceList}
These sentences use phrases associated with plurality (\q{a lot}, 
\q{too much}) but with referents that on perceptual and 
