...
pictures we develop via interprtive processes
...
lived in a state that does not recognize same-sex marriages.
...
logical rules, like \q{a bachelor is an unmarried man}.  Instead we
...
conceptualizations of the formal architecture of computing nvironments
...
to model phenomenal expenence, and Smith uses formal structures from
...
But nevertheless the almost life-like realism that
...
limited in the phenomenological context.  Peter G\"ardenfors,
...
the Semantic Web's (as G\"ardenfors puts it)
