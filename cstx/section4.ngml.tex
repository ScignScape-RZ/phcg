...
resists simple AI paradigms of languag
following essentially mechanical rules,
or logically decoding and processing symbols.
But at the same time, G\"ardenfors argues that
...
an exmplary \i{red tablecloth} would have
...
prototypical table cloths having prototypical rectangular
dimensions.
}
...
In general I think that these thories ar 
...
interfac interconnects \mdash{} but this \q{local} 
...
We need the everyday concpts and language 
...
for xample, goes hand-in-hand with a \i{holistic} 
...
fields like phenomenology nad Cognitive Grammar.  
...
is to look at Concptual Space theory as 
...
it seems counter-productive not call bird sounds orctacean
...
Jets (\ref{itm:rooting}, below)). This is consistent with the
