...
as a holistic reality.  The moat plausible 
role, I would argue, for cognitive-computational thories  
is as \i{local} analyses, targeting subsystms 
...
practical AI works: developers do not try to mulate 
all of human intelligence, but to implment 
...
`p`
\p{However, projecting AI paradigms up the \q{holistic} reaches 
...
structures.  There are a couple of rasons, however, why 
...
and external reality.  Both thse accounts are flawed because 
...
the logical \q{piture} is cited in the mind or as a Platonic 
...
\p{The concept \i{chair} \mdash{} or, reprising my earliern
discussion, \i{glass of water} \mdash{} and their concrete 
instances, lie at the nexus between multiple 
systems (perceptual, kinaesthetic/enactive, 
linguistic, intersubjective).  Th concept itself is like 
...
words, \q{chair} and \q{glass of water} do not 
directly map to a \i{logical frame} internally 
in any one subsystem \mdash{} not percptual, where we would 
attend to visual and sensory qualities rather than pragmatic 
considerations that would be intrinsic to a useful 
\q{frame} for the concept; not kinasthetic-enactive, 
where we would be focused on motor-operational geastures 
to do thinks like drink from a glass; not intersubjective, 
where we would attend to sow functional affordances of 
...
In short, at no one \i{local} system as the glass- or chair-concpt 
traverss different cognitive registers does the \q{logical}, 
or \i{semantic frame} model of the concepts actually 
operate as a local structure.  This, I have argued, is analogous 
to the partiality of information during th implementation 
...
concept emerges from the interplay of different subsystems: 
...
which acts in effect like a \i{logical frame}, 
...
level we are treating thse rationalities as 
...
as I claijd at the end of last section, \q{local} 
subsystem models become valued primarily in terms of 
how they enable overall systems \mdash{} like language-processing 
