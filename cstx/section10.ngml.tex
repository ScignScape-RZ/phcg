...
phrase-structure trees) \mdash{} cases like \i{student after student} have
...
seems arbitrary to select either \i{student}, or \i{after}, as \q{the}
representative of the phrase to link with \mdash{} for example \mdash{} the verb
\i{complained}; on that argument, the least arbitrary analysis is to
...
Considering \i{student after student} as an encapsulated phrase leaves
the singular/plural flexibility in the continuation of the sentence unexplained
(\i{Many students compained about \qmarkdubious{}his grade} is clearly dubious, so
...
linkage for \i{complained}.  I will address this particular ambiguity later;
...
guise, and \i{A procession of students complained about \qmarkdubious{}his grade} is straightforwardly
...
(cross-phrasal) link between \i{student} and \i{Three} \mdash{} clarifying that, considered
...
Dependency-style destructuring, with implicit type annotations.  \input{figure2.tex}
...
Even this may beg the question of what constitutes a \q{correct} parse: linguists
appear to rely principally on their own intuitions, based
on familiarity with the underlying theory; the idea they have of what a
\i{correct} \q{re-presentation} looks like (for link grammar, of the correct collection of
link types between the various words).  When developing \NLP{} software,
they then try to ensure that the human-generated representation
