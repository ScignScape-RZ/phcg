...
somewhere between those two.  But to the degree that
...
as grammatical complxes and accordingly (in my theory) as junctures
...
well addressed by type-theoretic mehods (both coarse and mid-grained).
}
