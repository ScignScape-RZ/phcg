...
other forms of speech also \mdash{} sometimes
...
(in pseudo-code):
\begin{sentenceList}\sentenceItem{} \label{itm:file} File f = File.open(path, File.READ\_ONLY);
...
cause the software representation of that
...
the Jets:
\begin{sentenceList}\sentenceItem{} \label{itm:rooting} Are you rooting for the Jets?
