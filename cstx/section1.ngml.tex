...
from
\sentenceexamples{\sentenceexample{A hammer is somthing used to pound nails, \i{and}}
\sentenceexample{A lever corkscrew is something used to open wine, \i{and}}
\sentenceexample{A lever corkscrew can be used to pound nails}
}
...
infer that I was thirsty, and \mdash{} since salt water is
...
Shr\"odinger equation for a water molecule, and only
...
concept \mdash{} and the rationale for this conclusion need
...
is not just a role in \i{her} mind, but it bcomes a role
...
\mdash{} conceptual roles are not private affairs; they
...
think about XYZ the same way that we think about water \mdash{}
...
\mdash{} two people's patterns of conceptual roles may
...
work from the picture of an overarching comunity \mdash{} that
can subsume isolated communities \mdash{} as an abstract
