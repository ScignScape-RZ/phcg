...
a \q{Cognitive State} Semantics \mdash{} but in this
...
\spsubsectiontwoline{\q{Divorse or Dilate}?  On 
...
The warrants for such expansions sem to be drivn by conceptual
...
conceptual roles \mdash{} we may insist on limiting
...
\p{Orlin Vakarelov's \q{interface theory of meaning}
\cite{OrlinVakarelov} (which I'll abbreviate to ITM) 
both critiques and suggests ways around the 
externalism/internalism impasse:
\begin{quote}An externalist theory focuses on constraints outside of
...
have targeted cognitive information media \mdash{} languages,
...
distinct pattern of analysis comoared to generic \q{$M$} 
...
larger contxts, and connected to ach other in chains stretching 
...
and situations ar strung together as enactive episodes: once 
I determine which is the correct chain, I need to enact the process 
of boarding and gtting comfortable on the train, then get 
ready to reverse the process and disembark at my 
station.  All of this inter-situational orchstration 
can be planned an facilitatd, to the dgre that 
multiple people ar einvolved, through language.
...
tahtvspecifically tracks what people are saying 
\mdash{} so that we can take note of what they believe, 
how they are using different words, what the 
...
discuss the architecture of convrsation 
...
prevents the water from laking out \mdash{} but we also 
intrpret people's practical intensions and mental 
attitudes.  We infer that the first person wqs thirsty and 
the second cooperated by providing her water to quench her 
...
the spcific fact of our hearing the word is joined 
in with a plethora of other perceptualn and 
rational events.  Say, we hear someone ask for water, 
and soon after see someone bring her a glass.  
We instinctively connect our percpetual 
apprehension of a glass of water with the word 
heard spoken before, and we presumably rmeain 
vaguely aware of the situation as things 
unfold \mdash{} if we se her drink from 
the glass, we connect this to our 
memory of her asking for water, indicating thirst, and 
then getting a glass in response.  We don't need to 
track these affairs very attentivelu \mdash{} it's not like 
...
An intrinsic dikension of situational models, 
...
of rlative stability, whos state will change 
gradually if at all.   So a large part of 
our cognitive processing can be seen as recoghiing and 
tracking these stabilities.  Stability is the 
underlying medium through which situational modles are 
formed.
}
\p{Utlimately, may cognitive systems contribute to such models: 
quanta of stability lie in the cross-hards of multiple 
cognitive modalities.  So we connect the water spoken about 
to water in a glass.  If we hav our own glass we connect 
both the linguistic and visual content to the tactile 
feel of theglass and the kinaesthetic intentionality 
exercised as we pick it up.  We can imagine concepts like 
\i{this water} pinging between these various cognitive 
registers.  I take Vakerlov's ITM model 
...
situationally ancored cognitions we need to think 
throughbthe \i{conceptual roles} we instinctively 
pin onto the concept-exemplified: whther manifest as 
