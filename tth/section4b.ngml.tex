...
\p{I will argue that type-related observations can be grouped (not necessarily
exclusively or exhaustively) into 
three \q{tiers} of linguistic organization \mdash{} three 
...
\p{My earlier analysis of phrasal units like 
\i{student after student} argued that
phrases cannot be treated, in general, as one-to-one replacements for semantic units.  Incorporating
...
of place \mdash{} or time, as in \i{at noon}).  Even with such refinements the 
macrotype-level \q{lambda reduction} remains however a useful summary of 
