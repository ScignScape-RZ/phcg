...
In Link Grammar, the connection between a verb and its 
assertorial direct object is labeled \TS{}.\footnote{Link Grammar models parses via interword relations classified according to 
...
\cite{KongRushSmith}, \cite{HongEisner}; 
and other writings compare both grammatic schools to 
more hierarchical phrase-structure grammars: 
\cite{Schneider}, \cite{XiaPalmer}. 
}  Consider the role of a \TS{}-link here \mdash{} 
