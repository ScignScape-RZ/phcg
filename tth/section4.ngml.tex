...
\p{The path toward such a hybrid methodology, as I will sketch it 
...
\i{primaried} for \i{subject without your own party to a primary 
challenge}.  Conversely, phrases can be repeatedly used in a 
specific context until they function as quasi lexical units in 
their own right.  These pattern of entrenchment imply that we 
