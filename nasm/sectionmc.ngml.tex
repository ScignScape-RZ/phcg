...
its staff, menu, and building.  
Certainly the staff, building, and menu are \q{parts} of a restaurant.
}
\p{Yet \q{sum of parts} here is not simplistic set-theoretical union; 
