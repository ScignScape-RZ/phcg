...
which can be called \q{hypernodes}.  So a directed 
...
In a frame model, several \i{edges} 
...
other hypernods.  A hypothetic case is 
outlined in Fig1d, with the assumption that 
elements in a hypernode are proxies for 
additional complx data structures.  For 
eaxmple, diagnostic codes can refer to 
...
\p{These four dofferent kinds of hypergraphs are to some degree 
...
\p{The diversity of rlated by not identical approaches points 
...
I enumerated four versions of hypergaphs \mdash{} and study 
