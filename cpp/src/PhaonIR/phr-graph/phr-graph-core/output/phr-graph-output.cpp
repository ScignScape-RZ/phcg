...
// if(caon_ptr<RE_Node> next_node = qy_.Run_Call_Sequence(pnode))
// {
//  qts << ' ';
//  output_from_node(qts, *next_node, indent + 1);
// }

// if(caon_ptr<RE_Node> next_node = qy_.Run_Call_Entry(pnode))
// {
...
//   if(caon_ptr<RE_Node> cross_node = qy_.Run_Cross_Sequence(pnode))
//   {
//    qts << ' ';
...
//   do_map_continue_node = qy_.Run_Nested_Do_Map_Block_Entry(temp_next_node);
...
// if(caon_ptr<RE_Node> next_node = qy_.Run_Block_Entry(pnode))
// {
//  qts << "\n" << padding;
//  qts << "(block ";
//  output_from_node(qts, *next_node, indent + 1);
//  if(caon_ptr<RE_Node> cross_node = qy_.Run_Cross_Sequence(next_node))
//  {
...
// if(caon_ptr<RE_Node> next_node = qy_.Run_Data_Entry(pnode))
// {
//  CAON_PTR_DEBUG(RE_Node ,next_node)
...
//   if(next_node = qy_.Run_Data_Entry(next_node))
//    output_from_node(qts, *next_node, indent + 1);
...
// if(caon_ptr<RE_Node> next_node = qy_.Run_Function_Def_Entry(pnode))
// {
//  CAON_PTR_DEBUG(RE_Node ,next_node)
//  next_node->debug_connections();
...
//  if(caon_ptr<RE_Node> call_entry_node = qy_.Run_Call_Entry(next_node))
//  {
//   if(caon_ptr<RE_Node> entry_node = qy_.Run_Cross_Sequence(call_entry_node))
//   {
