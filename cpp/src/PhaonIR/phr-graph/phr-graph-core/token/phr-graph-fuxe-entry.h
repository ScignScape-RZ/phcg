...
#ifndef PHR_GRAPH_FUXE_ENTRY__H
#define PHR_GRAPH_FUXE_ENTRY__H
...
public:
 ...
 PHR_Graph_Fuxe_Entry(QString channel_name, QString result_type_name);

};

_RZNS(PhrGraphCore)

#endif //PHR_GRAPH_FUXE_ENTRY
