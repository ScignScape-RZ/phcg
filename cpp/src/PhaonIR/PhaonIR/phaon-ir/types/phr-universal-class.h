...
#ifndef PHR_UNIVERSAL_CLASS__H
#define PHR_UNIVERSAL_CLASS__H
...
typedef void(PHR_Universal_Class::*fn0_type)();
typedef void(PHR_Universal_Class::*fn1_type)(void*&);
typedef void(PHR_Universal_Class::*fn2_type)(quint64&, quint64&);
typedef void(PHR_Universal_Class::*fn3_type)(void*&, void*&, void*&);


typedef void(PHR_Universal_Class::*s1_fn1_p_type)(pvft);

typedef void(PHR_Universal_Class::*fn1_p_type)(pvft);
typedef void(PHR_Universal_Class::*fn1_r_type)(quint64&);
typedef void(PHR_Universal_Class::*fn1_s_type)(QString);

typedef void*(PHR_Universal_Class::*fn1_p_wrtn_type)(pvft);
typedef void*(PHR_Universal_Class::*fn1_r_wrtn_type)(quint64&);
typedef void*(PHR_Universal_Class::*fn1_s_wrtn_type)(QString);
...
typedef void(PHR_Universal_Class::*fn2_pp_type)(pvft, pvft);
typedef void(PHR_Universal_Class::*fn2_rp_type)(quint64&, pvft);
typedef void(PHR_Universal_Class::*fn2_sp_type)(QString, pvft);

typedef void(PHR_Universal_Class::*fn2_pr_type)(pvft, quint64&);
typedef void(PHR_Universal_Class::*fn2_rr_type)(quint64&, quint64&);
typedef void(PHR_Universal_Class::*fn2_sr_type)(QString, quint64&);

typedef void(PHR_Universal_Class::*fn2_ps_type)(pvft, QString);
typedef void(PHR_Universal_Class::*fn2_rs_type)(quint64&, QString);
typedef void(PHR_Universal_Class::*fn2_ss_type)(QString, QString);


typedef void*(PHR_Universal_Class::*fn2_pp_wrtn_type)(pvft, pvft);
typedef void*(PHR_Universal_Class::*fn2_rp_wrtn_type)(quint64&, pvft);
typedef void*(PHR_Universal_Class::*fn2_sp_wrtn_type)(QString, pvft);

typedef void*(PHR_Universal_Class::*fn2_pr_wrtn_type)(pvft, quint64&);
typedef void*(PHR_Universal_Class::*fn2_rr_wrtn_type)(quint64&, quint64&);
typedef void*(PHR_Universal_Class::*fn2_sr_wrtn_type)(QString, quint64&);

typedef void*(PHR_Universal_Class::*fn2_ps_wrtn_type)(pvft, QString);
typedef void*(PHR_Universal_Class::*fn2_rs_wrtn_type)(quint64&, QString);
typedef void*(PHR_Universal_Class::*fn2_ss_wrtn_type)(QString, QString);

//typedef void(PHR_Universal_Class::*fng_type)();

typedef void(PHR_Universal_Class::*_s1_fng_type)();
typedef void*(PHR_Universal_Class::*s1_fng_type)();
