...
#ifndef RELAE_TXH_GRAPH__H
#define RELAE_TXH_GRAPH__H
...
class RTXH_Graph : public phaong<pg_t>
{
 RTXH_Node* root_node_;
...
public:
 ...
 RTXH_Graph(RTXH_Node* root_node = nullptr);
