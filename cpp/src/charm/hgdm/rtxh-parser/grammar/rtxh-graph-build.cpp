...
RTXH_Graph_Build::RTXH_Graph_Build(RTXH_Document* d, RTXH_Parser& p, RTXH_Graph& g)
 : Flags(0)
   ,document_(d)
   ,graph_(g)
   ,parser_(p)
   ,fr_(RTXH_Frame::instance())
...
void RTXH_Graph_Build::init()
{

}

void RTXH_Graph_Build::end_field()
{
...
void RTXH_Graph_Build::read_acc(QString s)
{
 acc_ += s;
}

void RTXH_Graph_Build::prepare_field_read(QString prefix, QString field, QString suffix)
{
 flags.discard_acc = false;
 if(suffix == ".")
...
void RTXH_Graph_Build::add_type(QString name, QString length)
{
...
void RTXH_Graph_Build::add_coda_data_line(QString qs)
{

}

void RTXH_Graph_Build::add_numeric_read_token(numeric_index_type val)
{
...
void RTXH_Graph_Build::add_read_token(QString text)
{
 if(current_field_name_.isEmpty())
 {
  graph_.add_read_token(current_hypernode_, current_type_name_,
...
void RTXH_Graph_Build::add_type_field_index(QString name, int code)
{
 if(code == 0)
...
void RTXH_Graph_Build::start_sample(QString ty)
{
...
void RTXH_Graph_Build::top_level_append()
{
 top_level_hypernodes_.push_back(last_hypernode_);
}

void RTXH_Graph_Build::array_append()
{
 if(current_hypernode_)
 {
  if(last_hypernode_)
...
void RTXH_Graph_Build::end_sample()
{
