...
#include "rtxh-grammar.h"

#include "rtxh-parse-context.h"

#include "rtxh-graph-build.h"

#include "rtxh-parser.h"

#include "relae-graph/relae-parser.templates.h"

USING_KANS(HGDMCore)

RTXH_Grammar::RTXH_Grammar()
{
}

void RTXH_Grammar::init(RTXH_Parser& p, RTXH_Graph& g, RTXH_Graph_Build& graph_build)
{
...
//? pre_rule( "end-of-line", "[__\\t\\S]* \\n" );
 ...
 RTXH_Parse_Context& parse_context = graph_build.parse_context();
