...
#include "qring/qring.h"

USING_KANS(KCM)
USING_KANS(KCL)
USING_KANS(QRing)

void run_lisp_file(KCM_Lisp_Eval& kle, QString script_file)
{
...
int rz_main(int argc, char* argv[])
{
 ...
 qDebug() << "Compiling PreDynamo to DynamoIR:" RZ_DIR "/t1.rz";
 ...
 qDebug() << "Running DynamoIR: " RZ_DIR "/t1.rz.dyn.cl";

 run_dynamo(kle, RZ_DIR "/t1.rz.dyn.cl", kenv);
